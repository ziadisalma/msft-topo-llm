...
REVAL_PROMPT = (
    """You enter the lobby and this time you encounter a new room, room 5. Room 5’s door leads to room 4.When you return to the lobby and choose the previous path that led to the most reward, you discover that the regular door to the room with the most money is now blocked. 
You go back to the lobby. You will only be able to choose one path that leads to the most money. 
Which room from the lobby will lead to the path where one can make the most money? Only return the room number"""
)
