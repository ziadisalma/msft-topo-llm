...
There’s a chest in room 3. You open it and there’s 10 dollars. Then you exit and start over.
This time in the lobby you choose room 2, then enter room 4. There’s
a chest with 50 dollars. You return to the lobby. Which room will you choose to make the
most money? Use minimal reasoning to get to the answer quickly.""" 
)
