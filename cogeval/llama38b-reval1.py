...
REVAL_PROMPT = (
    """Now you are dropped in room 1 and the door at its end suddenly leads to room 4, and then you're dropped in room 2 and the door at its end suddenly leads to room 3. You return to the lobby. Which room do you choose to make the most rewards? Use minimal reasoning to get to the answer quickly."""
)
