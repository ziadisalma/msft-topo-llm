...
REVAL_PROMPT = (
    """Now you’re dropped into room 1, then you enter room 3 and the chest has 100 dollars. Then
you’re taken out, and dropped into room 2, then you enter room 4 and the chest has the same
amount as before. Now you are back in the lobby. Which room do you choose to go next to make the most
reward. Use minimal reasoning to get to the answer quickly."""
)
