...
REVAL_PROMPT = (
    """Suddenly, in the lobby you’re presented with a new door which directly leads to room 4. Remember that you will only be able to choose one path
that leads to the most money. Which room from the lobby will lead to the path where one can make the most money? Use minimal reasoning to get to the answer quickly."""
)
