...
sentence_list = [
                ("(Rule #1) Only the largest element in each list can be moved to another list, and (Rule #2) an element can only be added to a list if it is larger than all other elements in the list", "A=[], B=[], C=[0,1,2]", ["A=[], B=[], C=[0,1,2]", "A=[2], B=[], C=[0,1]", "A=[], B=[], C=[2,1,0]"], "Yes"),
]

start_room = "A=[0,1,2], B=[], C=[]"

question = "if someone can get to {} from {}?"


request_template =    ['Given two rules and three lists, A, B, and C, determine ' + question + ' \n'
